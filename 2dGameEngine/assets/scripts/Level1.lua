...
----------------------------------------------------
-- Get Current Time of The Day From Os
----------------------------------------------------
local currentSystemHour = os.date("*t").hour
local mapTextureAssetId = "terrain-texture-day"

if currentSystemHour >= 9 and currentSystemHour <= 21 
	then
		io.write("It is ", currentSystemHour, " am", "\n")
end
if currentSystemHour >= 21 and currentSystemHour < 9
	then
		io.write("It is ", currentSystemHour, " pm\n")
end

----------------------------------------------------
-- Use a night-map or day-map texture (9am-9pm)
----------------------------------------------------
